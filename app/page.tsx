    ...
    <div className="min-h-screen">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(27, 75, 127, 0.75), rgba(27, 75, 127, 0.85)), url('/happy-person-in-wheelchair-with-caring-driver-smil.jpg')`,
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center p-6 bg-white/10 rounded-2xl backdrop-blur-sm hover:bg-white/15 transition-all duration-300 hover:scale-105">
                ...
                <div className="text-primary-foreground/90">Taxa de Satisfação</div>
              </div>
              <div className="text-center p-6 bg-white/10 rounded-2xl backdrop-blur-sm hover:bg-white/15 transition-all duration-300 hover:scale-105">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <Card className="p-8 hover:shadow-2xl transition-all duration-500 bg-card border-border hover:scale-105 hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold mb-3 text-card-foreground">Segurança Certificada</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Veículos Chevrolet Spin adaptados com cintos de segurança especiais, travas certificadas pelo INMETRO e
                equipamentos de última geração para sua proteção total. Inspeção rigorosa antes de cada viagem.
              </p>
            ...
            <Card className="p-8 hover:shadow-2xl transition-all duration-500 bg-card border-border hover:scale-105 hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold mb-3 text-card-foreground">Pontualidade Inglesa</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Seu tempo é precioso. Garantimos horários rigorosos com sistema de rastreamento GPS em tempo real e planejamento inteligente de rotas para que você nunca perca compromissos importantes.
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-accent" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-accent" />
                  Notificações de status da viagem
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-accent" />
            ...
            <Card className="p-8 hover:shadow-2xl transition-all duration-500 bg-card border-border hover:scale-105 hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold mb-3 text-card-foreground">Atendimento Humanizado</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Motoristas rigorosamente treinados e certificados, empáticos e dedicados ao seu conforto. Tratamos cada
                passageiro com respeito, dignidade e atenção personalizada. Seu bem-estar é nossa prioridade.
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-accent" />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <Card className="p-6 text-center hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <h4 className="font-bold text-lg mb-2">Equipe Especializada</h4>
              <p className="text-sm text-muted-foreground">
                Motoristas com treinamento em primeiros socorros e acessibilidade
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-24 bg-muted/30 animate-on-scroll">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-balance">O Que Nossos Clientes Dizem</h2>
            <p className="text-xl text-muted-foreground">Histórias reais de autonomia e liberdade</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                "Finalmente encontrei um serviço que trata a gente com dignidade. Os motoristas são atenciosos e os
                carros são impecáveis. Recomendo!"
              </p>
              <div className="font-semibold">Maria Silva</div>
              <div className="text-sm text-muted-foreground">Cliente há 2 anos</div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                "Nunca mais perco minhas consultas médicas. A pontualidade é impressionante e o suporte pelo WhatsApp é
                excelente."
              </p>
              <div className="font-semibold">João Santos</div>
              <div className="text-sm text-muted-foreground">Cliente há 1 ano</div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <div className="text-sm text-muted-foreground">Cliente há 6 meses</div>
            </Card>
          </div>
        </div>
      </section>
